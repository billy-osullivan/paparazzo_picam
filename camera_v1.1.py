# Paparzzo C/CS 12MP Camera v1.1
# Raspberry pi camera
# 
...
#
# Changes
# Added support to remove files via USB thumb drive, selectable in the menu
# Added a soft shutdown/poweroff to the menu options
#
#############
#
...
def menu(screen):
	...
	while 1:
		...
		menu_list8 = font.render('copy to usb', True, WHITE)
		menu_list9 = font.render('power off', True, WHITE)
		menu_list10 = font.render('exit', True, WHITE)
		...
		screen.blit(menu_list9, (60, 220))
		screen.blit(menu_list10, (60, 245))
		...
		screen.blit(settings_list0, (60, 270))
		screen.blit(settings_list1, (60, 295))
		screen.blit(settings_list2, (60, 320))
		screen.blit(settings_list3, (60, 345))
		screen.blit(settings_list4, (60, 370))
		screen.blit(settings_list5, (60, 395))
		screen.blit(settings_list6, (60, 420))
		...
		if GPIO.input(up) == GPIO.LOW and opt == 8:
			...
			opt = 9
			row = 220
		if GPIO.input(up) == GPIO.LOW and opt == 9:
			time.sleep(.5)
			opt = 10
			row = 245
		if GPIO.input(up) == GPIO.LOW and opt == 10:
			time.sleep(.5)
			opt = 1
			row = 25			
		...
		if GPIO.input(down) == GPIO.LOW and opt == 8:
			...
			opt =  7
			row = 175
		if GPIO.input(down) == GPIO.LOW and opt == 9:
			time.sleep(.5)
			opt =  8
			row = 195
		if GPIO.input(down) == GPIO.LOW and opt == 10:
			time.sleep(.5)
			opt =  9
			row = 220
		...
		if GPIO.input(select) == GPIO.LOW and opt == 8:
			time.sleep(.5)
			copystuff(screen)
		if GPIO.input(select) == GPIO.LOW and opt == 9:
			time.sleep(.5)
			shutdown(screen)
		if GPIO.input(select) == GPIO.LOW and opt == 10:
			time.sleep(.5)
			main()
...
def picview(screen):
	...
	try:
		...
		menu_list3 = font.render('Error reading a file, try copy to external media', True, WHITE)
		screen.blit(menu_list2, (20, 120))
		time.sleep(3)
...
def copystuff(screen):
	...
	while(1):
		...
		screen.fill(BLACK)
		font = pygame.font.SysFont(None, 30)
		menu_list1 = font.render('Press SELECT to copy files to removable storage', True, WHITE)
		menu_list2 = font.render('Press SELECT to exit', True, WHITE)
		screen.blit(menu_list1, (20, 20))
		screen.blit(menu_list2, (20, 45))
		...
		pygame.draw.rect(screen, RED, pygame.Rect(600, row, 20, 20))
		...
		if GPIO.input(select) == GPIO.LOW and opt == 1:
			...
			try:
				if os.path.exists('/dev/sda1') and os.path.ismount('/mnt') == False:
					os.system('sudo mount /dev/sda1 /mnt')
				if os.path.exists('/dev/sdb1') and os.path.ismount('/mnt') == False:
					os.system('sudo mount /dev/sdb1 /mnt')
				if os.path.exists('/dev/sdc1') and os.path.ismount('/mnt') == False:
					os.system('sudo mount /dev/sdc1 /mnt')
				if os.path.exists('/dev/sdd1') and os.path.ismount('/mnt') == False:
					os.system('sudo mount /dev/sdd1 /mnt')
				if os.path.exists('/dev/sde1') and os.path.ismount('/mnt') == False:
					os.system('sudo mount /dev/sde1 /mnt')
				if os.path.exists('/dev/sdf1') and os.path.ismount('/mnt') == False:
					os.system('sudo mount /dev/sdf1 /mnt')
				if os.path.exists('/dev/sdg1') and os.path.ismount('/mnt') == False:
					os.system('sudo mount /dev/sdg1 /mnt')
				try:
					os.system('sudo mkdir -p /mnt/picam_photos')
					os.system('sudo cp /home/billy/Desktop/photos/* /mnt/picam_photos')
					menu_list3 = font.render('Photos copied', True, WHITE)
					screen.blit(menu_list3, (20, 70))
					pygame.display.flip()
					time.sleep(3)
				except:
					menu_list3 = font.render('Error copying photos', True, WHITE)
					screen.blit(menu_list3, (20, 70))
					pygame.display.flip()
					time.sleep(3)
				try:
					os.system('sudo mkdir -p /mnt/picam_videos')
					os.system('sudo cp /home/billy/Desktop/videos/* /mnt/picam_videos')
					menu_list4 = font.render('Videos copied', True, WHITE)
					screen.blit(menu_list4, (20, 95))
					pygame.display.flip()
					time.sleep(3)
				except:
					menu_list4 = font.render('Error copying videos', True, WHITE)
					screen.blit(menu_list4, (20, 95))
					pygame.display.flip()
					time.sleep(3)
			except:
				menu_list5 = font.render('Error mounting media, try rebooting', True, WHITE)
				screen.blit(menu_list2, (20, 120))
				pygame.display.flip()
				time.sleep(3)
...
def shutdown(screen):
	...
	while(1):
		...
		screen.fill(BLACK)
		font = pygame.font.SysFont(None, 30)
		menu_list2 = font.render('Press SELECT to exit to menu', True, WHITE)
		menu_list1 = font.render('Press SELECT to POWER OFF camera', True, WHITE)
		screen.blit(menu_list1, (20, 20))
		screen.blit(menu_list2, (20, 45))
